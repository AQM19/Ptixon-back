...
{
    public class SamlRelayStateRepository : Repository<SamlRelayState>, ISamlRelayStateRepository
    {
        public SamlRelayStateRepository(DbContext context) : base(context)
        {
        }
