...
{
    public class SupabaseObjectRepository : Repository<SupabaseObject>, ISupabaseObjectRepository
    {
        public SupabaseObjectRepository(DbContext context) : base(context)
        {
        }
